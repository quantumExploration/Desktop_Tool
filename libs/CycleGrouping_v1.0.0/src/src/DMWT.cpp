...
inline void DMWT::appendTile(int64_t wec, float c, int t, int nxt1, int nxt2, vector<OneTile> &locTileVec){
...
inline int DMWT::appendTile(int64_t wec, float c, int t, int nxt1, int nxt2, vector<int> &curTile){
