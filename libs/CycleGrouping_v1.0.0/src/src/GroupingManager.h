...
public:
	...
	inline void setPara(char* _outDir, float _teta, float _randwb, int _nSmBefLoop, int _nLoop, int _nSmInLoop);
...
inline void GroupingManager::setPara(char* _outDir, float _teta, float _randwb, int _nSmBefLoop, int _nLoop, int _nSmInLoop){
