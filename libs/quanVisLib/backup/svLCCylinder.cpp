...
svLCCylinder::svLCCylinder(svVectorField *f) : svCylinderGlyph(f)
{
}
void svLCCylinder::RenderSample()
{
...
void svLCCylinder::GenerateTubes()
{
    int count1 = 0;
    int count2 = 0;
...
void svLCCylinder::GenerateIndex()
{  
    int index1 = 0;
    int count1 = 0;
    int index2 = 0;
...
void svLCCylinder::GenerateLegend()
{
    int count = 0;
    for(int i =0;i<seed_num;i++)
    {
...
void svLCCylinder::RenderLegend()
{
