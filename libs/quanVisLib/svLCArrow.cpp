...
namespace __svl_lib {
svLCArrow::svLCArrow(svQDOTData *d):svArrowGlyph(d)//svVectorField* f, int numPlane)
{
  //field = f;
...
void svLCArrow::SetColors(svColors *color){
  color->GetColors(myData, glyphColors);
}

void svLCArrow::GenerateArrows()
{
...
void svLCArrow::Generate() // this read specific data format
{
...
void svLCArrow::GenerateTexture() // this read specific data format
{
 // svGlyph::STILL_UPDATE = true;
