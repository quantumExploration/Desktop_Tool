...
//		printf("arc %d\n", arc);
		...
		glVertex2f(supernodes[topNode].xPosn, supernodes[topNode].yPosn);						//	draw top end of edge
                //printf("id %d location %d %f %f %e\n",arc,topNode, supernodes[topNode].xPosn,supernodes[topNode].yPosn, *(supernodes[bottomNode].value));
		glVertex2f(supernodes[bottomNode].xPosn, supernodes[bottomNode].yPosn);					//	draw bottom end of edge
//                printf("id %d location %d %d %f %f %f %f %e %e\n",arc,topNode, bottomNode, supernodes[topNode].xPosn,supernodes[topNode].yPosn, supernodes[bottomNode].xPosn,supernodes[bottomNode].yPosn, *(supernodes[topNode].value),
